...
- **SECTION_NAME** = [Human-readable name, e.g., "Contest Management" or "Analytics Insights"]
- **SECTION_ID** = [Folder name in sections/, e.g., "contest-management" or "analytics-insights"]
